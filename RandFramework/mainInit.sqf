...
[[chopper1]] call TRGM_fnc_addTransportActions;
[[chopper3]] call TRGM_fnc_addTransportActions;
[[chopper4]] call TRGM_fnc_addTransportActions;
...
TREND_fnc_CheckBadPoints = {
	...
	while {true} do {
		...
		if (isServer) then {
			...
			"transportChopper_1" setMarkerPos getPos chopper3;
			"transportChopper_3" setMarkerPos getPos chopper4;
		};
		sleep 1;
	};
};
